{{-- resources/views/karyawan/absensi/pulang-form.blade.php - AUTO SUBMIT + OPTIMASI --}}
    ...
    <div class="fullscreen-container">
        ...
        <div class="bottom-panel">
            ...
            <div class="status-grid">
                ...
                <div class="status-row">
                    <span class="status-label">Match Score</span>
            ...
            <form id="absenForm" action="{{ route('karyawan.absensi.pulang') }}" method="POST">
                @csrf
                ...
                <button type="submit" id="submitBtn" class="submit-btn" disabled>
                    <i class="fas fa-check"></i> Submit Clock Out
                </button>
            </form>
        </div>
...
// Gunakan Haversine formula yang sudah dioptimasi
