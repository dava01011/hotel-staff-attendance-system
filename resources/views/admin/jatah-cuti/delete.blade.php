{{-- resources/views/admin/jatah-cuti/delete.blade.php --}}

<div class="modal fade" id="hapusJatah{{ $item->id }}" tabindex="-1">
        ...
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-header border-0 pb-0" style="background:#fef2f2;">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0" style="font-size:14px;">Hapus Jatah Cuti</h6>
            ...
            <form action="{{ route('admin.jatah-cuti.destroy', $item->id) }}" method="POST">
                @csrf
                @method('DELETE')

                <div class="modal-body text-center py-4">
                    <p class="mb-1" style="font-size:13px;">
                        Yakin ingin menghapus jatah cuti untuk:
                    </p>
                    ...
                    <div class="mt-1" style="font-size:12px;color:#64748b;">
                        Tahun {{ $item->tahun }} &mdash; {{ $item->jatah }} hari
                    </div>
