<div class="modal fade" id="hapusDepartemen{{ $item->id }}" tabindex="-1">
        ...
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-header border-0 pb-0" style="background:#fef2f2;">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0" style="font-size:14px;">Hapus Departemen</h6>
            ...
            <form action="{{ route('admin.departemen.destroy', $item->id) }}" method="POST">
                @csrf
                @method('DELETE')
