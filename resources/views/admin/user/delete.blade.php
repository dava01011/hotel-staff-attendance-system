<div class="modal fade" id="hapusUser{{ $item->id }}" tabindex="-1">
        ...
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header border-0 pb-0" style="background:#fef2f2;">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h6 class="fw-bold mb-0" style="font-size:14px;">Hapus User</h6>
            ...
            <form action="{{ route('admin.user.destroy', $item->id) }}" method="POST">
                ...
                <div class="modal-body text-center py-4">
                    <p class="mb-1" style="font-size:13px;">Yakin ingin menghapus user:</p>
                    <div class="fw-bold" style="font-size:14px;color:#1e293b;">{{ $item->nama }}</div>
                    <p class="text-muted mt-2" style="font-size:12px;">
                        Data user akan dihapus permanen dan tidak bisa dikembalikan.
                    </p>
                </div>
